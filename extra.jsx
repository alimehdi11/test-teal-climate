...
const FrameComponent1 = ({
  ...
  const fetchElectricVehicle = async () => {
    const url = `${process.env.REACT_APP_API_BASE_URL}/electricVehicles?scope=${selectedScope}&level1=${selectedLevel}&level2=${fuelTypeValue}&level3=${fuelNameValue}&uom=${unitOfMeasurementValue}&unit=kWh`;
  ...
  const filterUnitOfMeasurementsBasedOnScopeAndLevel1 = () => {
    ...
    unitsOfMeasurement = [...new Set(unitsOfMeasurement)];
    console.table("selectedScope", selectedScope);
    console.table("selectedLevel", selectedLevel);
    console.table("unitOfMeasurements", unitOfMeasurements);
    return unitsOfMeasurement;
  };
