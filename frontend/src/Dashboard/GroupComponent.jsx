...
const GroupComponent = () => {
  return (
    <header className="self-stretch bg-white shadow-[0px_4px_50px_rgba(0,_0,_0,_0.05)] flex flex-row items-start justify-between py-3 px-6 box-border gap-[20px] top-[0] z-[99] sticky max-w-full text-left text-xs text-dark font-poppins">
      <div className="h-16 w-[100%] max-w-[1366px] relative bg-white shadow-[0px_4px_50px_rgba(0,_0,_0,_0.05)] hidden md:flex"></div>
      ...
      <div className="flex flex-row items-start justify-start gap-[12px]">
        ...
        />
        <img
          className="h-10 w-10 relative rounded-81xl object-cover min-h-[40px] z-[1]"
          loading="eager"
          alt=""
          src="/profile@2x.png"
        />
